...
checks_list = ["[-Wclazy-assert-with-side-effects]",
               ...
               "[-Wclazy-unused-result-check]",
               "[-Wclazy-use-arrow-operator-instead-of-data]",
               "[-Wclazy-use-chrono-in-qtimer]",
               "[-Wclazy-used-qunused-variable]",
               ...
               "[-Wclazy-modernize-overloaded-connects]",
